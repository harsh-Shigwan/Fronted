  ...
  return (
    ...
    <div className="flex flex-col pt-3 pb-12 mt-11 bg-white max-md:mt-10 max-md:max-w-full">
      ...
      <div className="flex flex-col flex-1 py-0.5 max-md:max-w-full">
        ...
        <input className="justify-center items-start py-4 pr-16 pl-4 mt-3 text-base leading-4 text-gray-500 whitespace-nowrap rounded-md bg-slate-100 max-md:pr-5 max-md:max-w-full" value={formData.account_name} name='account_name' type='text' 
        placeholder=' enter the account name' onChange={handleChange}>
      ...
      <div className="flex flex-col flex-1 py-0.5 max-md:max-w-full">
        ...
        <input className="justify-center items-start py-4 pr-16 pl-4 mt-2 text-base leading-4 text-gray-500 whitespace-nowrap rounded-md bg-slate-100 max-md:pr-5 max-md:max-w-full" name='balance' type='number' placeholder=' enter the balance' value={formData.balance} onChange={handleChange}>
...
export default Account_Ledger_Form