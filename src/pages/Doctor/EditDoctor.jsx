...
export default function Add_Doctor() {
  ...
  const handleSubmit = () => {
    ...
    axios.put(`${baseURL}/doctor/api/doctors/${pk}/`, formDataToSubmit, {
      headers: {
        Authorization: `Token ${token}`,
      },
    })
        ...
        {activeStep === 1 && (
          ...
          <div className="max-md:max-w-full">
            ...
            <option className='text-gray-500 text-base font-medium leading-4' value="Teacher">Teacher</option>
                  ...
                  <div >
                    <input className="justify-between  border-transparent  w-[500px] items-stretch bg-slate-100 text-gray-500 flex gap-5 mt-2 px-3.5 py-4 rounded-md max-md:max-w-full max-md:flex-wrap" type='text' name='working_details'  value={formData.working_details}
                onChange={handleChange}
