    ...
    <Router>
      <Routes>
        <Route element={<AuthenticationRoute />}>
          ...
          ></Route>
          <Route
            path="/Inventory/Add_Medicine_Inventory"
            element={<Add_Medicine_Inventory />}
          ></Route>
          {/*Patient*/}
          ...
          <Route
            path="/Patient/IPD/Add_Patient/IPD_View/:admission_id"
            element={<IPD_View />}
          ></Route>
          <Route path="/Patient/IPD/EditIPD/:pk" element={<EditIPD />} />{" "}
          <Route
            path="/IPD/IPD_Dishcharged/:admission_id"
            element={<Discharged />}
          ></Route>
          <Route
            path="/patient/IPD/Discharged_List/"
            element={<DischargedList />}
          ></Route>
          <Route
          ...
          <Route
            path="/Doctor/Details/Doctor_Profile/:DoctorID"
         ...
         <Route path="/Invoice_Generator/medi/:patientId" element={<Medi/>}></Route>
          ...
          ></Route>
          <Route
            path="/Accounts/Account_Profile/Recipt_Voucher"
            element={<Recipt_Form />}
          ></Route>
          <Route
            path="/Accounts/Account_Profile/Payment_Form"
            element={<Payment_Form />}
          ></Route>
          <Route
            path="/Accounts/Account_Profile/CashBook"
            element={<CashBook_Form />}
          ></Route>
          <Route
            path="/Accounts/Account_Profile/Account_Ledger"
            element={<Account_Ledger_Form />}
          ></Route>
          <Route
            path="/PatientGraph"
